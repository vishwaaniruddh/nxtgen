...
<? 
$sql1 = mysqli_query($con,"select distinct(Zone) as zone from sites where Zone in($zone)"); 
...
<?
$sql = mysqli_query($con,"select distinct(CTS_LocalBranch) as branch,Zone from sites where Zone ='".$zone."' and CTS_LocalBranch not in('','0')");
